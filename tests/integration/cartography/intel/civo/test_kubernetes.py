...
def test_civo_kubernetes_graph(mock_account_get, mock_kubernetes_get, neo4j_session):
    ...
    firewall_id relationship matchers are exercised here at the transform/
    property level only. The PART_OF_NETWORK/PROTECTED_BY edges themselves
    require the separate Networking PR's node types to resolve against and
