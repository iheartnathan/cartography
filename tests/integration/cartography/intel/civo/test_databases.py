...
def test_civo_database_no_password_reaches_graph(
    ...
    """
    CivoDatabase loaded standalone - network_id/firewall_id relationship
    ...
    Networking PR's node types to resolve against and can't be verified
    from this PR in isolation (see the PR split plan).
    """
    # Arrange
